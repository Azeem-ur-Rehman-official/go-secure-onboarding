...
console.log("steps",step);
  ...
  return (
    <section className="min-h-screen bg-[#09111F] py-16 px-5">
      <div className="mx-auto max-w-3xl overflow-hidden rounded-2xl border border-[#233454] bg-[#0D1526] shadow-[0_20px_60px_rgba(0,0,0,.45)]">
...
{step>3 && (
  <div className="flex flex-col items-center justify-center space-y-4">
    ...
    <p className="text-gray-400">Thank you for completing the onboarding process.</p>
    <p className="text-gray-400">Our team will contact you soon.</p>
  </div>
)}
{step <= 3 && (<> <p className="mb-2 text-gray-400">
